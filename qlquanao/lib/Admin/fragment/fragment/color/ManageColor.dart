...
class _HomeState extends State<Home> {
    ...
    return Scaffold(
      ...
      body: FirebaseAnimatedList(
        ...
        itemBuilder: (context, snapshot, animation, index) {
          ...
          g = v.replaceAll(
              RegExp("{|}|colorName: |colorHex: "), ""); // webfun, subscribe
          g.trim();
  ...
  upd() async {
    DatabaseReference ref1 = FirebaseDatabase.instance.ref("colors/$k");

// Only update the name, leave the age and address!
    await ref1.update({
      "colorName": second.text,
      "colorHex": third.text,
    });
    second.clear();
    third.clear();
